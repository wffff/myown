...
import com.snkj.www.repository.IUserRepository;
...
public class UserService implements IUserService, UserDetailsService {
    ...
    public UserEntity loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        if (user != null) {
            ...
            return new UserEntity(user.getId(), user.getOrganizationId(), user.getOrganization(), user.getUsername(), user.getPassword(), user.getFullname(), grantedAuthorities);
        } else {
    ...
    public UserEntity save(String username, String password, String fullname, Integer organizationId) {
        ...
        if (u == null) {
            ...
            if (null == organizationId) {
                OrganizationEntity organizationEntity = iOrganizationService.save(null, OrganizationTypeEnum.COMPANY, username + "的公司", null);
